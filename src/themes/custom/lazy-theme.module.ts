...
import { FeaturedGalleryComponent } from './app/home-page/featured-gallery.component';
...
// Standalone components that should be imported
...
// Non-standalone components that should be declared
const NON_STANDALONE_DECLARATIONS = [
  // All components are now standalone
];

@NgModule({
  declarations: NON_STANDALONE_DECLARATIONS,
  imports: [
    RootModule,
    CommonModule,
    DragDropModule,
